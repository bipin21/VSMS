...
-->
                ...
                <input type="text" class="form-control" placeholder="Chasis Number" name="chasis" value="{{$editid->model}}" required ><br/>
              </div><br/>
                                     <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-money">&nbsp;Quantity</i></span>
                <input type="text" class="form-control" placeholder="Quantity" name="quantity" value="{{$editid->units}}" required ><br/>
              </div><br/>
                                    <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-money">&nbsp;Reg_no</i></span>
                <input type="text" class="form-control" placeholder="Registration Number" name="reg_no" value="{{$editid->model}}" required ><br/>
              </div><br/>
                                     <div class="input-group">
            ...
            <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-picture-o">&nbsp;Unit Price in NRS</i></span>
                 <input type="text" class="form-control" placeholder="Unit Price" name="unitprice" value="{{$editid->price}}" required ><br/>
              </div><br/>
            <div class="input-group">
